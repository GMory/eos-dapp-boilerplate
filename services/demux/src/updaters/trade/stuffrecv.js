...
const stuffrecv = async (db, payload, blockInfo) => {
  ...
  await new tradeRepository(db).stuffrecv(payload.data.trade_id, data)

  // log it to the console
  helpers.logger("Stuff received")
}

module.exports = stuffrecv